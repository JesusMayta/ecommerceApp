...
export const initialData: SeedData = {
    users: [
        {
            email: 'rimverse@gmail.com', name: 'Jesus Mayta', password: bcryptjs.hashSync('123456789'), role: 'admin'
        }, {
            email: 'emma@gmail.com', name: 'Emma Mayta', password: bcryptjs.hashSync('123456789'), role: 'user'
        }, {
            email: 'gaby@gmail.com', name: 'Gaby Pacori', password: bcryptjs.hashSync('123456789'), role: 'user'
        },
    ],
    categories: [
